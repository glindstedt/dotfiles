...
tags = {
    names = {"一", "二", "三", "四","五","六","七","八","九","十"}, --names = {". ","..",":.","::","|:","||","(|","()","O","="},
    layout = {layouts[1], layouts[1], layouts[1], layouts[12], layouts[12], layouts[12], layouts[12], layouts[12], layouts[12], layouts[12]}
  }
for s = 1, screen.count() do
...
separator:set_markup("<span>|</span>")
...
batwidget:set_background_color("#EB0000")
batwidget:set_border_color(nil)
batwidget:set_color("#92DB00")
...
vicious.register(volwidget, vicious.widgets.volume, 
                  function (widget, args)
                    if args[2] == '♩' or args[1] == 0 then
                      return colred .. "<span><b>" .. args[1] .. "%</b></span>" .. coldef
                    else
                      return "<span><b>" .. args[1] .. "%</b></span>"
                    end
                  end
                  , 11, 'Master')
--}}}
...
globalkeys = awful.util.table.join(
    ...
    -- Audio keys, volume control & update widget
    -- for alsa:
    ...
    -- Create bindings for Modkey+0 to tag #10
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
                     ...
                     size_hints_honor = false} }, --remove ugly borders for maximised terminal
    { rule = { class = "MPlayer" },
...
-- wireless fix
awful.util.spawn_with_shell("sudo rfkill unblock all")
awful.util.spawn_with_shell("sudo ip link set wlan0 up")

-- fix two finger side scroll
